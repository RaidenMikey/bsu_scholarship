@php
  ...
  // Calculate percentages for progress bars based on campus-specific applications
  $calculatePercentage = function($scholarship) {
  ...
  $scholarshipsAll->each($calculatePercentage);
  $scholarshipsPrivate->each($calculatePercentage);
  $scholarshipsGov->each($calculatePercentage);
@endphp
