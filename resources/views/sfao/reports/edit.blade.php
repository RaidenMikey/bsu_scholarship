        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('sfao.dashboard') }}" class="text-white hover:text-gray-200 px-3 py-2 rounded-md text-sm font-medium">
                        ← Back to Dashboard
                    </a>
                </div>
            </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-6">
                        ...
                        <select name="campus_id" id="campus_id" required 
                            ...
                            @foreach($monitoredCampuses as $monitoredCampus)
                                <option value="{{ $monitoredCampus->id }}" {{ old('campus_id', $report->campus_id) == $monitoredCampus->id ? 'selected' : '' }}>
