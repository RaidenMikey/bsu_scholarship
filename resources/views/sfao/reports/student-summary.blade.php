...
@section('navbar-title', 'Student Summary Report | ' . (request('campus_id') == 'all' ? 'All Campuses' : ($monitoredCampuses->where('id', request('campus_id'))->first()->name ?? 'Unknown Campus')))
@section('back-url', route('sfao.dashboard', ['tab' => 'reports-student_summary']))
