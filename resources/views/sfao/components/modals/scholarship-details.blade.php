    ...
    <div class="relative w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden transform"
        ...
        <div class="p-6">
            ...
            <div class="mt-8 flex justify-end gap-3">
                ...
                <button type="button" @click="showDetails_{{ $scholarship->id }} = false; showReleaseGrant_{{ $scholarship->id }} = true" class="px-4 py-2 bg-bsu-red text-white rounded-lg hover:bg-red-700 transition flex items-center gap-2">
